...
class AdvertisersControllerTest < ActionController::TestCase
  ...
  test "should create advertiser" do
    assert_difference('Advertiser.count') do
      post :create, advertiser: { details: @advertiser.details, title: @advertiser.title, user_id: @advertiser.user_id, uuid: @advertiser.uuid }
    end
  ...
  test "should update advertiser" do
    patch :update, id: @advertiser, advertiser: { details: @advertiser.details, title: @advertiser.title, user_id: @advertiser.user_id, uuid: @advertiser.uuid }
    assert_redirected_to advertiser_path(assigns(:advertiser))
  end
